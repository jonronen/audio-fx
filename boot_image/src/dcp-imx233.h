...
int imx233_dcp_memcpy_ex(int channel, bool fill, const void *src, void *dst, size_t len);
int imx233_dcp_memcpy(bool fill, const void *src, void *dst, size_t len, int tmo);

int imx233_dcp_blit_ex(int channel, bool fill, const void *src, size_t w, size_t h, void *dst, size_t out_w);
int imx233_dcp_blit(bool fill, const void *src, size_t w, size_t h, void *dst, size_t out_w, int tmo);
